 ...
 */
@JsonIgnoreProperties(ignoreUnknown = true, value = {"session", "mailSession", "listePiecesJointes",
        "MimeMessage message", "fromAddress", "emailBody", "content", "toList", "ccList", "bccList",
        "replyList", "replyTo", "from"})
public class EmailImpl
{
    ...
    @JsonIgnore protected MimeMessage message;
    ...
    @JsonIgnore private MimeMultipart container;
    @JsonIgnore private BodyPart primaryBodyPart;
    ...
    public EmailImpl setFrom(String email)
    {
        return setFrom(email, null);
    }
    public EmailImpl setFrom(String email, String name)
    {
        return setFrom(email, name, null);
    }
    public EmailImpl setFrom(String email, String name, String charset)
    {
        this.fromAddress = createInternetAddress(email, name, charset);
        return this;
    }
    public EmailImpl setFrom(InternetAddress adresse)
    {        
        this.fromAddress = adresse;
        return this;
    }
    public EmailImpl setFrom(EmailAdresse adresse)
    {        
    ...
    public EmailImpl addTo(EmailList adresses)
    {        
    ...
    public EmailImpl addTo(EmailAdresse adresse)
    {        
        return addTo(adresse.getAdresseMail(), adresse.getNom());
    }
    public EmailImpl addTo(String email)
    {
        return addTo(email, null);
    }
    public EmailImpl addTo(String email, String name)
    {
        return addTo(email, name, null);
    }
    public EmailImpl addTo(String email, String name, String charset)
    {
        this.toList.add(createInternetAddress(email, name, charset));
        return this;
    }
    public EmailImpl setTo(Collection<InternetAddress> aCollection)
    {
    ...
    public EmailImpl addTo(InternetAddress adresse)
    {        
        this.toList.add(adresse);
        return this;
    }
    public EmailImpl addTo(List<InternetAddress> adresses)
    {        
        this.toList.addAll(adresses);
        return this;
    }

    public EmailImpl addTo(InternetAddress[] adresses)
    {        
        if (adresses != null)
        {
    ...
    public EmailImpl addCc(EmailList adresses)
    {      
    ...
    public EmailImpl addCc(EmailAdresse adresse)
    {        
        return addCc(adresse.getAdresseMail(), adresse.getNom());
    }
    public EmailImpl addCc(String email)
    {
        return addCc(email, null);
    }
    public EmailImpl addCc(String email, String name)
    {
        return addCc(email, name, null);
    }
    public EmailImpl addCc(String email, String name, String charset)
    {
        this.ccList.add(createInternetAddress(email, name, charset));
        return this;
    }
    public EmailImpl setCc(Collection<InternetAddress> aCollection)
    {
        if ((aCollection == null) || (aCollection.isEmpty()))
        {
            throw new ProcessusException(ADDRESS_LIST_PROVIDED_WAS_INVALID);
    ...
    public EmailImpl addCc(InternetAddress adresse)
    {        
        this.ccList.add(adresse);
        return this;
    }
    public EmailImpl addCc(List<InternetAddress> adresses)
    {        
        this.ccList.addAll(adresses);
        return this;
    }

    public EmailImpl addCc(InternetAddress[] adresses)
    {      
        if (adresses != null)
        {
            for (InternetAddress adress : adresses)
    ...
    public EmailImpl addBcc(EmailList adresses)
    {        
        for (EmailAdresse adresse : adresses.getListeEmailAdresses())
        {
    ...
    public EmailImpl addBcc(EmailAdresse adresse)
    {        
        return addCc(adresse.getAdresseMail(), adresse.getNom());
    }        
    public EmailImpl addBcc(String email)
    {
        return addBcc(email, null);
    }
    public EmailImpl addBcc(String email, String name)
    {
        return addBcc(email, name, null);
    }
    public EmailImpl addBcc(String email, String name, String charset)
    {
        this.bccList.add(createInternetAddress(email, name, charset));
        return this;
    }
    public EmailImpl setBcc(Collection<InternetAddress> aCollection)
    {
        if ((aCollection == null) || (aCollection.isEmpty()))
        {
            throw new ProcessusException(ADDRESS_LIST_PROVIDED_WAS_INVALID);
    ...
    public EmailImpl addBcc(InternetAddress adresse)
    {        
        this.bccList.add(adresse);
        return this;
    }
    public EmailImpl addBcc(List<InternetAddress> adresses)
    {        
        this.bccList.addAll(adresses);
        return this;
    }

    public EmailImpl addBcc(InternetAddress[] adresses)
    {        
        if (adresses != null)
        {
            for (InternetAddress adress : adresses)
    ...
    public EmailImpl addReplyTo(EmailAdresse adresse)
    {        
        return addReplyTo(adresse.getAdresseMail(), adresse.getNom());
    } 
    public EmailImpl addReplyTo(String email)
    {
        return addReplyTo(email, null);
    }
    public EmailImpl addReplyTo(String email, String name)
    {
        return addReplyTo(email, name, null);
    }
    public EmailImpl addReplyTo(String email, String name, String charset)
    {
        this.replyList.add(createInternetAddress(email, name, charset));
        return this;
    }
    public EmailImpl setReplyTo(Collection<InternetAddress> aCollection)
    {
        if ((aCollection == null) || (aCollection.isEmpty()))
        {
            throw new ProcessusException(ADDRESS_LIST_PROVIDED_WAS_INVALID);
    ...
    public EmailImpl setBounceAddress(String email)
    {
    ...
    public EmailImpl addPart(String partContent, String partContentType)
    {
    ...
    public EmailImpl addPart(MimeMultipart multipart)
    {
        try
        {
    ...
    public EmailImpl addPart(MimeMultipart multipart, int index)
    {
        BodyPart bodyPart = createBodyPart();
        try
        {
    ...
    public void setHtmlMsg(String msg)
    {
    	...
    	try
    	{
			mimeMessage.setContent(msg, EmailImpl.TEXT_HTML);
    ...
    public EmailImpl attach(EmailAttachement attachment)
    {
        EmailImpl result = null;
        if (attachment == null)
        {
    ...
    public EmailImpl attach(URL url, String name, String description)
    {
        return attach(url, name, description, ATTACHMENT);
    }
    public EmailImpl attach(URL url, String name, String description, String disposition)
    {
        try
        {
    ...
    public EmailImpl attach(DataSource ds, String name, String description)
    {
        try
        {
    ...
    public EmailImpl attach(DataSource ds, String name, String description, String disposition)
    {
        if (StringUtil.isEmpty(name))
        {
            name = ds.getName();
    ...
    public String toString()
    {
        ...
        ObjectWriter writer = mapper.writer().withoutAttribute("session").withoutAttribute("mailSession");
        try {
